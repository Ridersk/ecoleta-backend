                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image_url: process.env.HOST + ":" + process.env.PORT + "/uploads/" + point.image });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedPoint = __assign(__assign({}, point), { image_url: process.env.HOST + ":" + process.env.PORT + "/uploads/" + point.image });
